...
import { apiGetSuppliers, apiCreateSupplier, apiGetSupplierTransactions, apiDeleteSupplier, Supplier, SupplierTransactions } from '../../app/api_client';
...
export default function Suppliers_Page() {
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      alert('Không thể xoá nhà cung cấp');
    }
  };
